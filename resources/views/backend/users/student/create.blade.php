...
@section('title', 'Admin | Admin Create Student')
...
<div class="card card-body shadow mt-5">
    ...
    <form style="padding: 10px" method="POST" action="{{ route('admin.student.store') }}" enctype="multipart/form-data" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        @csrf
