        ...
        <form action="#" method="POST">
            ...
            <div class="row">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="video_link" class="form-control" placeholder="https://youtube.com/..." required>
                </div>

                {{-- <!-- Position -->
                <div class="mb-3">
                    <label class="form-label">Position</label>
                    <input type="number" name="position" class="form-control" value="1" min="1">
                </div> --}}
