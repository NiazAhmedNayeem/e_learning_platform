...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-lg-10">
             ...
             <div id="profileView">
                @include('backend.admin_profile.profile_view')
            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea name="bio" id="bio" rows="2" 
                                                class="form-control @error('bio') is-invalid @enderror">{{ old('bio', $admin->bio) }}</textarea>
                                        @error('bio') <div class="invalid-feedback d-block">{{ $message }}</div> @enderror
                                    </div>

                                    <!-- Submit -->
                                    <div class="d-flex justify-content-end gap-2 mt-4">
                                        <button id="cancelEdit" class="btn btn-danger btn-lg shadow-sm">Cancel</a>
        ...
        $(document).ready(function(){
            ...
            $('#image').on('change', function (e) {
                ...
                if (this.files && this.files[0]) {
                    reader.readAsDataURL(this.files[0]); // image load preview in circle
                }
            });
