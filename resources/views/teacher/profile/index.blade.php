...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-lg-10">
            ...
            <div id="profileView">
                @include('teacher.profile.profile_view')
            </div>
...
@section('scripts')
    <script>
        $(document).ready(function(){
                ...
                $.ajax({
                    ...
                    error: function(xhr){
                        if(xhr.status == 422){
                            ...
                            $('#categoryError').html(errors.expertise_category_id ? errors.expertise_category_id[0] : '');
                        }
                    },
                });
            });
            ...
            $('#expertise_category_id').on('input', function(){
                $('#categoryError').html('');
            });
