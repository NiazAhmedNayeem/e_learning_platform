        ...
        <div class="col-md-8">
            <div class="card shadow-lg border-0 rounded-4 p-4">
                ...
                <div class="card border-0 rounded-3 shadow-sm p-3 mb-4 text-center bg-light">
                    ...
                    <div class="mt-3">
                        <button class="badge bg-danger me-2 px-3 py-2" data-bs-toggle="modal" data-bs-target="#bkashModal">
                            <i class="fas fa-money-bill-wave me-1"></i> Pay with bKash
                        </button>
                        <button class="badge bg-warning text-dark px-3 py-2" data-bs-toggle="modal" data-bs-target="#nagadModal">
                            <i class="fas fa-money-bill-wave me-1"></i> Pay with Nagad
                        </button>
                    </div>
                </div>
            </div>
        ...
        <form method="POST" action="{{ route('frontend.order.store') }}">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="number" name="number" class="form-control" required placeholder="01XXXXXXXXX">
